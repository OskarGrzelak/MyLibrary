...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Search; });\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n\r\nclass Search {\r\n    constructor(query) {\r\n        this.query = query;\r\n    }\r\n\r\n    async getResults() {\r\n        try {\r\n            const res = await axios__WEBPACK_IMPORTED_MODULE_0___default()(`https://www.googleapis.com/books/v1/volumes?q=${this.query}&key=AIzaSyCMh3GiKQZWIPumFfEMBEkfKebbMbOLKak`);\r\n            this.result = res.data.items;\r\n        } catch(err) {\r\n            console.log(err);\r\n        }\r\n    }\r\n}\n\n//# sourceURL=webpack:///./src/js/models/Search.js?");

/***/ }),

/***/ "./src/js/models/Wishes.js":
/*!*********************************!*\
  !*** ./src/js/models/Wishes.js ***!
  \*********************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return bookView; });\nclass bookView {\r\n    constructor() {\r\n        this.elements = {\r\n            bookTitle: document.getElementById('book-title'),\r\n            bookAuthor: document.getElementById('book-author'),\r\n            bookCover: document.getElementById('book-cover'),\r\n            bookDescription: document.getElementById('book-description')\r\n        }\r\n    }\r\n\r\n    showBookDetails(books, id) {\r\n        const index = books.findIndex(el => el.id === id);\r\n        this.elements.bookTitle.textContent = books[index].title;\r\n        this.elements.bookAuthor.textContent = books[index].author;\r\n        this.elements.bookDescription.innerHTML = books[index].limitDescription();\r\n        this.elements.bookCover.src = books[index].cover;\r\n        return books[index];\r\n    }\r\n}\n\n//# sourceURL=webpack:///./src/js/views/bookView.js?");

/***/ }),

/***/ "./src/js/views/libraryView.js":
/*!*************************************!*\
  !*** ./src/js/views/libraryView.js ***!
  \*************************************/
/*! exports provided: renderLibrary, clearLibrary */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"renderLibrary\", function() { return renderLibrary; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clearLibrary\", function() { return clearLibrary; });\n!(function webpackMissingModule() { var e = new Error(\"Cannot find module './views/base'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n/* harmony import */ var _models_Book__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/Book */ \"./src/js/models/Book.js\");\n\r\n\r\n\r\nconst renderLibrary = (books) => {\r\n    books.forEach(book => {\r\n        const markup = `\r\n            <li>\r\n                <div class=\"book\" id=\"${book.id}\">\r\n                    <div class=\"book__info\">\r\n                        <h3 class=\"book__title\">${book.title}</h3>\r\n                        <p class=\"book__author\">${book.author}</p>\r\n                        <p class=\"book__status book__status--not-readed\">${book.status === 'not readed' ? 'You have not read this book yet' : 'You have read this book'}</p>\r\n                    </div>\r\n                    <div class=\"book__actions\">\r\n                        <ul>\r\n                            <li class=\"book__action book__action--show\">More</li>\r\n                            <li class=\"book__action book__action--change\">Change status</li>\r\n                            <li class=\"book__action book__action--del\">Delete book</li>\r\n                        </ul>\r\n                    </div>\r\n                </div>\r\n            </li>\r\n        `;\r\n        !(function webpackMissingModule() { var e = new Error(\"Cannot find module './views/base'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).libraryList.insertAdjacentHTML('afterbegin', markup);\r\n    });\r\n};\r\n\r\nconst clearLibrary = () => !(function webpackMissingModule() { var e = new Error(\"Cannot find module './views/base'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).libraryList.innerHTML = '';\n\n//# sourceURL=webpack:///./src/js/views/libraryView.js?");
...
/*!************************************!*\
  !*** ./src/js/views/searchView.js ***!
  \************************************/
/*! exports provided: getInput, clearInput, clearResults, limitTitle, renderResult, renderResults */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getInput\", function() { return getInput; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clearInput\", function() { return clearInput; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clearResults\", function() { return clearResults; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"limitTitle\", function() { return limitTitle; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"renderResult\", function() { return renderResult; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"renderResults\", function() { return renderResults; });\n!(function webpackMissingModule() { var e = new Error(\"Cannot find module './views/base'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n\r\n\r\nconst getInput = () => {\r\n    const title = !(function webpackMissingModule() { var e = new Error(\"Cannot find module './views/base'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).searchTitle.value;\r\n    const author = !(function webpackMissingModule() { var e = new Error(\"Cannot find module './views/base'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).searchAuthor.value;\r\n    const isbn = !(function webpackMissingModule() { var e = new Error(\"Cannot find module './views/base'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).searchISBN.value;\r\n    let query = '';\r\n    if(title) {\r\n        query += `intitle:${title}+`;\r\n    }\r\n    if(author) {\r\n        query += `inauthor:${author}+`;\r\n    }\r\n    if(isbn) {\r\n        query += `isbn:${isbn}`;\r\n    }\r\n    return query;\r\n}\r\n    \r\nconst clearInput = () => {\r\n    !(function webpackMissingModule() { var e = new Error(\"Cannot find module './views/base'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).searchTitle.value = '';\r\n    !(function webpackMissingModule() { var e = new Error(\"Cannot find module './views/base'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).searchAuthor.value = '';\r\n    !(function webpackMissingModule() { var e = new Error(\"Cannot find module './views/base'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).searchISBN.value = '';\r\n}\r\n\r\nconst clearResults = () => undefined.elements.searchList.innerHTML = '';\r\n    \r\nconst limitTitle = (title, limit = 42) => {\r\n    const newTitle = [];\r\n    if(title.length > limit) {\r\n        title.split(' ').reduce((acc, cur) => {\r\n            if(acc + cur.length <= limit) {\r\n                newTitle.push(cur);\r\n            }\r\n            return acc + cur.length;\r\n        }, 0);\r\n    \r\n        // return the result\r\n        return `${newTitle.join(' ')} ...`;\r\n    } \r\n    return title;\r\n};\r\n    \r\nconst renderResult = (result) => {\r\n    const markup = `\r\n        <li>\r\n            <div class=\"results__item\" id=\"${result.id}\">\r\n                <h3 class=\"results__title\">${limitTitle(result.volumeInfo.title)}</h3>\r\n                <p class=\"results__author\">${result.volumeInfo.authors}</p>\r\n                <div class=\"results__actions\">\r\n                    <ul>\r\n                        <li class=\"results__action results__action--add\">Add to lib</li>\r\n                        <li class=\"results__action results__action--wish\">Add as wish</li>\r\n                    </ul>\r\n                </div>\r\n            </div>\r\n        </li>\r\n    `;\r\n    !(function webpackMissingModule() { var e = new Error(\"Cannot find module './views/base'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).searchList.insertAdjacentHTML('beforeend', markup);\r\n};\r\n    \r\nconst renderResults = (results) => {\r\n    if(results) {\r\n        results.forEach(result => undefined.renderResult(result));\r\n    } else {\r\n        alert('there are no results');\r\n    }\r\n};\n\n//# sourceURL=webpack:///./src/js/views/searchView.js?");

/***/ }),

/***/ "./src/js/views/wishesView.js":
/*!************************************!*\
  !*** ./src/js/views/wishesView.js ***!
  \************************************/
/*! exports provided: default */
